...
-- have placed at least 2 orders and spent more than ₹5,000. Order by total amount spent 
-- in descending order.
...
-- different products sold, total quantity sold, and total revenue generated. Only 
-- include categories that have generated more than ₹10,000 in revenue. Order by 
